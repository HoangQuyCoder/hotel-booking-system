...
public class NotificationController {
        ...
        @PreAuthorize("hasRole('ADMIN')")
        public ResponseEntity<ApiResponse<NotificationTemplateResponse>> getTemplate(@PathVariable @NonNull UUID id) {
        ...
        @PreAuthorize("hasRole('ADMIN')")
        public ResponseEntity<ApiResponse<Void>> deleteTemplate(@PathVariable @NonNull UUID id) {
        ...
        @GetMapping("/logs/{id}")
        public ResponseEntity<ApiResponse<NotificationLogResponse>> getLog(@PathVariable @NonNull UUID id) {

...
public class ReviewController {
        ...
        // DELETE REVIEW
        @DeleteMapping("/{id}")
        public ResponseEntity<ApiResponse<Void>> deleteReview(@PathVariable @NonNull UUID id) {
        ...
        // GET ONE REVIEW
        @GetMapping("/{id}")
        public ResponseEntity<ApiResponse<ReviewResponse>> getReview(@PathVariable @NonNull UUID id) {
